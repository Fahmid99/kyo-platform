...
interface KeyValuePair {
  colorScheme: { primary: string; stroke: string; fill: string; strokeWidth: number; };
  key: string;
  value: string;
  confidence: number;
  pageNumber: number;
...
const AnalyzeResultsPage = () => {
  ...
  useEffect(() => {
    ...
    if (navState?.analysisData) {
      ...
      // Transform the analysis results to match AnalysisData interface
      // eslint-disable-next-line @typescript-eslint/no-explicit-any
      const results = analysisState.analysisResults as any;
      
      // Ensure all required properties exist with defaults
      dataToUse = {
        title: results.title || "Untitled Document",
        keyValuePairs: results.keyValuePairs || [],
  ...
  return (
    <AnalysisResultsContext.Provider value={contextValue}>
